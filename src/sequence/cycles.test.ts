...
describe("createCycles", () => {
  ...
  test("creates daily cycles", () => {
    ...
    const result = createCycles(start, end, 1, "days", "plus", 100, "daily", mockGenId);
  ...
  test("creates weekly cycles", () => {
    ...
    const result = createCycles(start, end, 1, "weeks", "minus", 50, "weekly", mockGenId);
  ...
  test("creates monthly cycles", () => {
    ...
    const result = createCycles(start, end, 1, "months", "plus", 200, "monthly", mockGenId);
  ...
  test("creates yearly cycles", () => {
    ...
    const result = createCycles(start, end, 1, "years", "plus", 1000, "yearly", mockGenId);
  ...
  test("creates hourly cycles", () => {
    ...
    const result = createCycles(start, end, 1, "hours", "minus", 25, "hourly", mockGenId);
  ...
  test("creates minute cycles", () => {
    ...
    const result = createCycles(start, end, 1, "minutes", "plus", 5, "minute", mockGenId);
  ...
  test("creates second cycles", () => {
    ...
    const result = createCycles(start, end, 1, "seconds", "plus", 1, "second", mockGenId);
  ...
  test("handles step greater than 1", () => {
    ...
    const result = createCycles(start, end, 3, "days", "plus", 10, "every3days", mockGenId);
  ...
  test("returns single item when start equals end", () => {
    ...
    const result = createCycles(date, date, 1, "days", "plus", 50, "single", mockGenId);
  ...
  test("generates unique ids for each item", () => {
    ...
    const start = new Date("2024-01-01");
    const end = new Date("2024-01-03");
    const result = createCycles(start, end, 1, "days", "plus", 10, "test", uniqueGenId);
